...
--
-- /See:/ <https://cloud.google.com/speech/ Google Cloud Speech API Reference> for @speech.operations.cancel@.
module Network.Google.Resource.Speech.Operations.Cancel
    (
    -- * REST Resource
...
-- | A resource alias for @speech.operations.cancel@ method which the
