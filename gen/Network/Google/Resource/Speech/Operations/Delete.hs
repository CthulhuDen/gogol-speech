...
--
-- /See:/ <https://cloud.google.com/speech/ Google Cloud Speech API Reference> for @speech.operations.delete@.
module Network.Google.Resource.Speech.Operations.Delete
    (
    -- * REST Resource
...
-- | A resource alias for @speech.operations.delete@ method which the
